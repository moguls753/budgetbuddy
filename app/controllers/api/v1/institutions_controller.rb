    ...
    class InstitutionsController < ApplicationController
      def index
        ...
        when "enable_banking"
          ...
          return render json: { error: "Enable Banking not configured" }, status: :unprocessable_entity unless credential
        ...
        when "gocardless"
          ...
          return render json: { error: "GoCardless not configured" }, status: :unprocessable_entity unless credential
